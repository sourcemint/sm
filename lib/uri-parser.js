...
vendors["sourcemint-paths"] = function(parsedUri) {
    var m;
    // `.sm/cache/external/https/github.com/.../.../tarball/0b4ed5f08a32c280a76d0b5f52883d8d1fc0de08`
    if((m = parsedUri.pathname.match(/\/\.sm\/cache\/external\/(.*?)\/([^\/]*)$/))) {
        var info = {};
    ...
    // `.sm/cache/install/node-v0.6.21-pre/git/github.com/.../.../0b4ed5f08a32c280a76d0b5f52883d8d1fc0de08`
    if((m = parsedUri.pathname.match(/\/\.sm\/cache\/install\/[^\/]*\/(.*?)\/([^\/]*)$/))) {
        var info = {};
