...
//            git: false,
        ...
        if (node.descriptors.package) {
            info.uid = node.descriptors.package.uid || false;
            info.repositoryUri = repositoryFromDescriptor(node.descriptors.package);
            info.homepageUri = (typeof node.descriptors.package.homepage === "string" && node.descriptors.package.homepage) || false;
        ...
        if (node.descriptors.package && node.descriptors.package.rev) {
            info.rev = node.descriptors.package.rev;
        }
                ...
                try {
                    ...
                    if (node.descriptors.smSource && node.descriptors.smSource.engine) {
                        ...
                        if (info.engineVersion !== engineVersion || info.engineName != node.descriptors.smSource.engine.name) {
                            ...
                            if (node.descriptors.package && node.descriptors.package.engines) {
